...
export default class Signup extends Component {
        ...
        return (
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                <View style={styles.container}>
                    ...
                    <Text style={{ textAlign: 'center', marginBottom: 25, fontSize: 25,}}>Sign Up</Text>
                    ...
                    <TouchableOpacity style={styles.loginBtn} onPress={this.handleEmailSignUp}>
    ...
    handleEmailSignUp = () => {
        ...
        .then((userCredential) => {
            ...
            console.log('Account Creation Succeeded! email: ', user.email); 
